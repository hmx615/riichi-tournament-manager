...
export function IndividualCompetitionOverview({ competition, summary, showBackLink = false, admin }: {
  ...
  return <div className="page competition-page">
    ...
    <section className="section-block">
      ...
      {settings && <ul className="workflow"><li><b>1</b><div><strong>初赛 <em className="stage-seal stage-seal-preliminary">{stageStatus("preliminary")}</em></strong><small>{settings.stages.preliminary.matchCountPerPlayer} 半庄/人{(settings.stages.preliminary.advancingPlayerCount ?? 0) > 0 ? ` · ${settings.stages.preliminary.advancingPlayerCount} 人晋级半决赛` : ""}{(settings.preliminaryDirectFinalPlayerCount ?? 0) > 0 ? ` · ${settings.preliminaryDirectFinalPlayerCount} 人直通决赛` : ""}</small></div></li><li><b>2</b><div><strong>半决赛 <em className="stage-seal stage-seal-semifinal">{stageStatus("semifinal")}</em></strong><small>{settings.stages.semifinal.matchCountPerPlayer} 半庄/人{(settings.semifinalAdvancingPlayerCount ?? settings.stages.semifinal.advancingPlayerCount ?? 0) > 0 ? ` · ${settings.semifinalAdvancingPlayerCount ?? settings.stages.semifinal.advancingPlayerCount} 人晋级决赛` : ""}</small></div></li><li><b>3</b><div><strong>决赛 <em className="stage-seal stage-seal-final">{stageStatus("final")}</em></strong><small>{settings.stages.final.matchCountPerPlayer} 半庄/人</small></div></li></ul>}
      <h3>待开赛</h3>

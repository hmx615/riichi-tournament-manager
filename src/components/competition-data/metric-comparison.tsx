...
const groups: Array<{ title: string; metrics: Metric[] }> = [
  {
    ...
    metrics: [
      ...
      ["自摸率", "rate"], ["默听率", "rate"], ["流听率", "rate"], ["先制率", "rate"],
      ["追立率", "rate"], ["平均起手向听", "decimal"],
    ],
  },
  {
    title: "打点与收支",
    metrics: [
      ["平均打点", "point"], ["平均铳点", "point"], ["被炸率", "rate"], ["平均被炸点数", "point"],
      ["打点效率", "point"], ["铳点损失", "point"], ["净打点效率", "signed"], ["局收支", "signed"],
      ["里宝率", "rate"], ["平均里宝数", "decimal"],
    ],
  },
  {
    title: "立直与副露",
    metrics: [
      ...
      ["副露后和牌率", "rate"], ["副露后放铳率", "rate"], ["副露后流局率", "rate"],
    ],
  },
];

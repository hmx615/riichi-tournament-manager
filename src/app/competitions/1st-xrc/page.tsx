...
export default async function CompetitionPage() {
  ...
  const [summary, personRanks, admin, player] = await Promise.all([computeCompetitionSummary(competition), loadPersonEstimatedRanks(), isAdmin(), currentPlayer()]);
  ...
  return <CompetitionOverview competition={competition} summary={summary} participantRanks={participantRanks} admin={admin} canEnterMatches={admin || Boolean(player)} />;
}

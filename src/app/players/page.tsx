...
export default async function PlayersPage() {
  ...
  return <div className="page players-page">
    ...
    <section className="summary-grid"><div className="summary-block"><span>登记人物<strong>{people.length}</strong></span></div><div className="summary-block"><span>人类选手<strong>{humanCount}</strong></span></div><div className="summary-block"><span>魂天实力<strong>{celestialCount}</strong></span></div></section>
